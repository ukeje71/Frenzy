...
const Billing = () => {
  ...
  const validateForm = () => {
    const errors = {};
    if (!formData.addressLine1.trim()) errors.addressLine1 = "First line of address is required";
      ...
      <section className="w-full p-4 md:p-8">
        ...
        <div className="mb-8">
          ...
          <div className="hidden lg:flex items-center text-sm text-gray-600 space-x-4">
            ...
            <span className="font-medium text-green-600">Billing & Address</span>
            <div className="flex items-center">
              <div className="w-6 h-px bg-gray-300"></div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border ${formErrors.addressLine1 ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all`}
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border ${formErrors.streetName ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all`}
                    value={formData.streetName}
                    onChange={handleInputChange}
                  />
                  {formErrors.streetName && (
                    <p className="mt-1 text-sm text-red-600">{formErrors.streetName}</p>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 border ${formErrors.phoneNumber ? 'border-red-300' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all`}
          ...
          <div className="lg:w-1/3">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <button
                ...
                className={`w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-medium py-3 px-4 rounded-lg mt-6 transition-all shadow-md hover:shadow-lg ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
                {isSubmitting ? (
              ...
              <NavLink to="/cart" className="inline-flex items-center text-gray-600 hover:text-green-600 mt-6 transition-colors">
